...
function ev_mousedown(ev)
{
   ...
   if (g_gameState == "splash")
   {
      ...
      else if ( x > 50 && x < 200 && y > 340 && y < 370 )
      {
         ...
         g_context.fillText("遥遥星辰中，内战正酣，星际海盗趁乱掠夺",60,100);
         g_context.fillText("各星球上的宝藏文物。",60,125);
         g_context.fillText("但这并不意味着他们会坐视不管。",60,150);
         g_context.fillStyle = "white";
         g_context.fillText("方向键/WSAD = 移动",60,285);
         g_context.fillText("空格 = 射击",60,310);
         g_context.fillText("收集能量和宝物",60,335);
         g_context.fillText("P键暂停游戏",60,365);
         g_context.fillText("无键盘可使用屏幕控制",60,390);
...
function ev_mousemove(ev)
{
   ...
   if ( x > 50 && x < 200 && y > 340 && y < 370 )
   {
      ...
      g_context.fillStyle = "white";
      g_context.fillText("游戏说明",52,361);
   }
   else
   {
      g_context.fillStyle = "black";
